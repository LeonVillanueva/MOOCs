# -*- coding: utf-8 -*-
"""
Created on Thu Dec 26 13:14:59 2019
...
y_pred_prob = class_nb.predict_proba (X_test)
print (y_pred)
print (y_pred_prob)
...
plt.contourf(X1, X2, class_nb.predict(np.array([X1.ravel(), X2.ravel()]).T).reshape(X1.shape),
